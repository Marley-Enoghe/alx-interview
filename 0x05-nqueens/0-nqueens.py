#!/usr/bin/python3
'''This is the solution to thr nqueens problem'''
import sys


def is_valid(board, row, col):
    """
  To check if a position of the queen is valid
    Args:
...
def nqueens_helper(board, col):
    """
    The helper function for nqueens
    Args:
        board: 2D array representing the board
...
def print_board(board, n):
    """
    To print positions of the queens
    Args:
        board: 2D array representing the board
        n: size of the board
    Returns:
